...
export function CheckInSettings() {
  ...
  return <section className="my-6 rounded-xl border border-outline-variant/20 p-4" aria-label="Inactivity settings">
    ...
    <p className="text-sm">{detection.detail} Only native device inactivity is used. Hidden, frozen, discarded or closed pages may not detect inactivity; returning starts fresh observation. Time away from Timebox never proves inactivity.</p>
