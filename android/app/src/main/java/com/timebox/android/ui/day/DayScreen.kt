...
fun DayScreen(
    ...
    onReverseSelectedCompletion: () -> Unit,
    onRequestSelectedTaskCompletion: () -> Unit,
    onConfirmSelectedTaskCompletion: (Boolean) -> Unit,
    ...
    if (state.sheetOpen) {
        BlockSheet(
            ...
            onReverseCompletion = onReverseSelectedCompletion,
            onRequestTaskCompletion = onRequestSelectedTaskCompletion,
            onConfirmTaskCompletion = onConfirmSelectedTaskCompletion,
            onDismissTaskCompletion = onDismissTaskCompletion,
