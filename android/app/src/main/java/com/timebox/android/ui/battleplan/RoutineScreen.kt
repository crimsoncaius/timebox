            ...
            Column(Modifier.fillMaxWidth().imePadding().verticalScroll(rememberScrollState()).padding(20.dp), verticalArrangement = Arrangement.spacedBy(12.dp)) {
                ...
                when (field) {
                    ...
                    "Task Type" -> {
                        ...
                        TaskTypePicker(recommendationName = recommendationName, recommendationEnabled = !busy, taskTypes = state.taskTypes, query = query, onQueryChange = { query = it }, selectedTypeId = draft.taskTypeId,
