...
- While highlighting, Calendar shows a breadcrumb back to the source range (for example "Trends › Week · Sep 21 – 27") and one sentence: the Task Type, its contributing days out of the range's days, and its total, as in "meetings on 2 of 7 days, 2h 5m in total." Parent path segments are muted. "Show all activity" clears the highlight.
